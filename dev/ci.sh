...
case "$1" in
  ...
  test)
    ...
    # CI uses `cargo nextest run --locked --workspace`
    ...
    run_in_ci "cargo test --locked --workspace --features zeroclaw-channels/heavy-tests,zeroclaw-runtime/heavy-tests --verbose"
    ;;
