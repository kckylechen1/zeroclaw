...
cli-status-companion-outbox-accumulating = Companion outbox: accumulating ({$pending} pending)
cli-status-companion-outbox-accumulating-oldest = Companion outbox: accumulating ({$pending} pending, oldest {$age}s)
