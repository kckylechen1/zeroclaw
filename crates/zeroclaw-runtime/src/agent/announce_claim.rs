...
/// (the surviving spawn producer is the coordinator's
/// `subagent_persistence::SubagentPersistence` write path; the retired
/// `crate::tools::spawn_subagent` and `crate::tools::delegate` seams used to
/// be the others), because it is
