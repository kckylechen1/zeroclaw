...
| Dependency footprint or feature-profile change | [Dependency footprint measurement](./dependency-footprint.md), [Crates](../architecture/crates.md), [Core-residency rationale](./core-residency-rationale.md), [CI & Actions](../maintainers/ci-and-actions.md) | Keep package-graph measurements separate from tool visibility and runtime costs; use root-scoped normal/build closure and preserve default compatibility. |
