...
| [ADR-014](./ADR-014-reviewed-agentsoul-projection.md) | proposed | Reviewed AgentSoul uses a closed presentation-only review and projection contract. |
...
ADR-014 records the owner-selected minimum Slice A contract. It remains proposed
until independent documentation review and grants no #189/#190 activation.
