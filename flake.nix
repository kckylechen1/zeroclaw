  ...
  outputs = { flake-utils, fenix, nixpkgs, ... }:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        zeroclawDefaultFeatures = [ "acp-bridge" "agent-runtime" "channel-acp-server" "channel-discord" "channel-email" "channel-filesystem" "channel-lark" "channel-matrix" "channel-telegram" "channel-webhook" "gateway" "hardware-tools" "integrations-saas" "observability-prometheus" "schema-export" "whatsapp-web" ];
